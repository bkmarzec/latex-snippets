...
% Steuerbus
%
\node[black] at ($(m3.west)+(-2,3)$) (label1) {$A_3$}; \node[black] at ($(m0.east)+(2,3)$) (label2) {$0$};
\node[black] at ($(m3.west)+(-2,2.5)$) (label3) {$A_2$}; \node[black] at ($(m0.east)+(2,2.5)$) (label4) {$1$};
\node[black] at ($(m3.west)+(-2,2)$) (label5) {$A_1$}; \node[black] at ($(m0.east)+(2,2)$) (label6) {$0$};
\node[black] at ($(m3.west)+(-2,1.5)$) (label7) {$A_0$}; \node[black] at ($(m0.east)+(2,1.5)$) (label8) {$1$};
\path[draw=black,-]
  (label1) -- (label2)
  (label3) edge[red] (label4)
  (label5) -- (label6)
  (label7) edge[red] (label8)
;
\path[draw=black,-]
  ($(m3.north)+(0.75,0)$) edge[red] ($(m3.north)+(0.75,0.75)$)
  ($(m3.north)+(0.25,0)$) -- ($(m3.north)+(0.25,1.25)$)
  ($(m2.north)+(0.75,0)$) edge[red] ($(m2.north)+(0.75,0.75)$)
  ($(m2.north)+(0.25,0)$) -- ($(m2.north)+(0.25,1.25)$)
  ($(m1.north)+(0.75,0)$) edge[red] ($(m1.north)+(0.75,0.75)$)
  ($(m1.north)+(0.25,0)$) -- ($(m1.north)+(0.25,1.25)$)
  ($(m0.north)+(0.75,0)$) edge[red] ($(m0.north)+(0.75,0.75)$)
  ($(m0.north)+(0.25,0)$) -- ($(m0.north)+(0.25,1.25)$)
;
\fill[black] 
  ($(m3.north)+(0.25,1.25)$) circle (2pt)
...
\fill[red] 
  ($(m3.north)+(0.75,0.75)$) circle (2pt)
  ($(m2.north)+(0.75,0.75)$) circle (2pt)
  ($(m1.north)+(0.75,0.75)$) circle (2pt)
  ($(m0.north)+(0.75,0.75)$) circle (2pt)
;

%
% Datenbus
%
\node[black] at ($(m3.west)+(-2,-11)$) (label9) {$D_3$}; \node[black] at ($(m0.east)+(2,-11)$) (label10) {$0$};
\node[black] at ($(m3.west)+(-2,-11.5)$) (label11) {$D_2$}; \node[black] at ($(m0.east)+(2,-11.5)$) (label12) {$1$};
\node[black] at ($(m3.west)+(-2,-12)$) (label13) {$D_1$}; \node[black] at ($(m0.east)+(2,-12)$) (label14) {$1$};
\node[black] at ($(m3.west)+(-2,-12.5)$) (label15) {$D_0$}; \node[black] at ($(m0.east)+(2,-12.5)$) (label16) {$1$};
\path[draw=black, -]
  (label9) -- (label10)
  (label11) edge[red] (label12)
  (label13) edge[red] (label14)
  (label15) edge[red] (label16)
;

\node[bt, below = 1cm of m3] (t3) {$T_3$};
\node[bt, below = 2cm of m2] (t2) {$T_2$};
\node[bt, below = 3cm of m1, fill=red!15, draw=red] (t1) {$T_1$};
\node[bt, below = 4cm of m0] (t0) {$T_0$};

\path[draw=black]
  ($(m3.south)+(.75,0)$) -- ($(t3.north)+(.75,0)$)
  ($(m2.south)+(.25,0)$) -- ($(t2.north)+(.25,0)$) 
  ($(m2.south)+(-.25,0)$) -- ($(t2.north)+(-.25,0)$) ($(m2.south)+(.75,0)$) -- ($(t2.north)+(.75,0)$)
  ($(m1.south)+(-.75,0)$) -- ($(t1.north)+(-.75,0)$)
  ($(m0.south)+(-.75,0)$) -- ($(t0.north)+(-.75,0)$) 
  ($(m0.south)+(-.25,0)$) -- ($(t0.north)+(-.25,0)$) 
  ($(m0.south)+(.25,0)$) -- ($(t0.north)+(.25,0)$)   
;
\path[draw=red]
  ($(m3.south)+(-.75,0)$) -- ($(t3.north)+(-.75,0)$) 
  ($(m3.south)+(-.25,0)$) -- ($(t3.north)+(-.25,0)$)
  ($(m3.south)+(.25,0)$) -- ($(t3.north)+(.25,0)$) 
  ($(m2.south)+(-.75,0)$) -- ($(t2.north)+(-.75,0)$)
  ($(m1.south)+(-.25,0)$) -- ($(t1.north)+(-.25,0)$) 
  ($(m1.south)+(.25,0)$) -- ($(t1.north)+(.25,0)$) 
  ($(m1.south)+(.75,0)$) -- ($(t1.north)+(.75,0)$)
  ($(m0.south)+(.75,0)$) -- ($(t0.north)+(.75,0)$)  
;
...
\path[draw, red] ($(t1.south)+(-.25, 0)$)  |- (or3.input 2);
\path[draw, red] ($(t1.south)+(.25, 0)$)  |- (or2.input 2);
\path[draw, red] ($(t1.south)+(.75, 0)$)  |- (or1.input 2);
% T0-zu or gates
...
;
\path[draw=red] (or1.output) -- ++(right:5mm) |- ($(label16)-(3mm,0)$);
\path[draw=red] (or2.output) -- ++(right:5mm) |- ($(label14)-(9mm,0)$);
\path[draw=red] (or3.output) -- ++(right:5mm) |- ($(label12)-(16mm,0)$);


\fill[black] ($(label10)-(22mm,0)$) circle (2pt);
\fill[red] ($(label16)-(3mm,0)$) circle (2pt) ($(label14)-(9.5mm,0)$) circle (2pt) ($(label12)-(15.5mm,0)$) circle (2pt);
...
%
\draw[-]
  ($(deco.east)-(0.25,0)$) edge ($(deco.east)-(0.25,-5)$)
  ($(deco.east)-(-0.25,0)$) edge[red] ($(deco.east)-(-0.25,-4.5)$)
;
\fill[black]($(deco.east)-(0.25,-5)$) circle (2pt);
\fill[red]($(deco.east)-(-0.25,-4.5)$) circle (2pt);
